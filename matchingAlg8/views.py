...
class MyPage(Page):
    ...
    def is_displayed(self):
        return self.round_number == 1 and self.participant.vars["condition"] == 2
...
class ResultsWaitPage(WaitPage):
    ...
    def is_displayed(self):
        return self.round_number != 1 and self.player.participant.vars.get('statusActive') and self.participant.vars["condition"] == 2
...
class ResultsOptions(Page):
    ...
    def is_displayed(self):
        return self.player.participant.vars.get('statusActive') and self.participant.vars["condition"] == 2
